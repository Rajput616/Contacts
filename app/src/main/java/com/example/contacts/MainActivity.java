    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RoomDatabase.Callback myCallBack = new RoomDatabase.Callback() {
            ...
            public void onCreate(@NonNull SupportSQLiteDatabase db) {
                ...
                //These are 4 contacts already created in the app when installed (Built_in_Contacts)
//                CreateContact("Saurabh", "Saurabh@gmail.com");
//                CreateContact("Nupur", "Nupur@gmail.com");
//                CreateContact("Aman", "Aman@gmail.com");
//                CreateContact("Amit", "Amit@gmail.com");
...
//        contactArrayList.addAll(contactsAppDatabase.getContactDAO().getContacts());
    ...
    public void addAndEditContacts(final boolean isUpdated, final Contact contact, final int position) {
        ...
        TextView contactTitle = view.findViewById(R.id.new_contact_tile);
    ...
    private void DisplayAllContactsInBG(){
        ...
        executorService.execute(new Runnable() {
            ...
            public void run() {
                ...
                //Execute after bg work has finished
